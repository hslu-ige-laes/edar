...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/comfortSia180ThermCmf0-1} \caption{Raw Data Room and Outdoor Temperaturefor SIA180 Thermal Comfort Plot}\label{fig:comfortSia180ThermCmf0-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/comfortSia180ThermCmf0-2} \caption{Raw Data Room and Outdoor Temperaturefor SIA180 Thermal Comfort Plot}\label{fig:comfortSia180ThermCmf0-2}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/eleHousehold} \caption{Plot Electricity Household}\label{fig:unnamed-chunk-23}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/roomTempRed} \caption{Room Temperature Reduction Plot}\label{fig:unnamed-chunk-24}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotBldgEngySigScatter} \caption{Building Energy Signature Plot}\label{fig:unnamed-chunk-25}
\end{figure}
