...
\KeywordTok{library}\NormalTok{(lubridate)}
 ...
 \OperatorTok{%>%}\StringTok{ }\OperatorTok{%>%}\StringTok{ }\OperatorTok{%>%}\StringTok{ }\OperatorTok{%>%}\StringTok{ }\NormalTok{df}\OperatorTok{$}\NormalTok{year <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{cut}\NormalTok{(df}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"year"}\NormalTok{))}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{df}\OperatorTok{$}\NormalTok{hour <-}\StringTok{ }\KeywordTok{as.POSIXct}\NormalTok{(lubridate}\OperatorTok{::}\KeywordTok{floor_date}\NormalTok{(df}\OperatorTok{$}\NormalTok{time,}\StringTok{"hours"}\NormalTok{), }\DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{)}
\NormalTok{df}\OperatorTok{$}\NormalTok{minute <-}\StringTok{ }\KeywordTok{as.POSIXct}\NormalTok{(lubridate}\OperatorTok{::}\KeywordTok{floor_date}\NormalTok{(df}\OperatorTok{$}\NormalTok{time,}\StringTok{"minutes"}\NormalTok{), }\DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{)}
\NormalTok{df}\OperatorTok{$}\NormalTok{second <-}\StringTok{ }\KeywordTok{as.POSIXct}\NormalTok{(lubridate}\OperatorTok{::}\KeywordTok{floor_date}\NormalTok{(df}\OperatorTok{$}\NormalTok{time,}\StringTok{"seconds"}\NormalTok{), }\DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(df, }\DataTypeTok{temp_f =}\NormalTok{ temp_c }\OperatorTok{*}\StringTok{ }\FloatTok{1.8} \OperatorTok{+}\StringTok{ }\DecValTok{32}\NormalTok{)}

\CommentTok{# This code does the same, but only with a pipe}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(df, }\DataTypeTok{temp_f =}\NormalTok{ temp_c }\OperatorTok{*}\StringTok{ }\FloatTok{1.8} \OperatorTok{+}\StringTok{ }\DecValTok{32}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(df, }\DataTypeTok{temp_f =}\NormalTok{ temp_c }\OperatorTok{*}\StringTok{ }\FloatTok{1.8} \OperatorTok{+}\StringTok{ }\DecValTok{32}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
...
The \href{https://www.tidyverse.org/}{`Tidyverse'} is a collection of R packages designed for data science. See \href{https://www.tidyverse.org/packages/}{tidyverse.org/packages/} for an up-to-date list of included packages. Beside these core packages, a lot of other packages base on the same philosopy, e.g.~\href{https://tidyverts.org/}{`tidyverts' - a collection of tidy tools for time series}.
...
The \href{https://tsibble.tidyverts.org/}{`tsibble'} package provides a data infrastructure for tidy temporal data with wrangling tools. Adapting the forementioned tidy data principles, tsibble is a data- and model-oriented object.
...
\hypertarget{loading-data-and-parsing-timestamp}{%
\subsubsection{Loading data and parsing timestamp}\label{loading-data-and-parsing-timestamp}}
...
\hypertarget{tidy-up}{%
\subsubsection{tidy up}\label{tidy-up}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# separate datapoint into two columns}
\NormalTok{df.separated <-}\StringTok{ }\NormalTok{df.long }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{separate}\NormalTok{(}\DataTypeTok{col =}\NormalTok{ datapoint, }\DataTypeTok{into =} \KeywordTok{c}\NormalTok{(}\StringTok{"flat"}\NormalTok{, }\StringTok{"sensor"}\NormalTok{), }\DataTypeTok{sep =} \StringTok{"_"}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate_at}\NormalTok{(}\StringTok{"flat"}\NormalTok{, str_replace, }\StringTok{"Flat"}\NormalTok{, }\StringTok{""}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{na.omit}\NormalTok{()}

\KeywordTok{head}\NormalTok{(df.separated, }\DecValTok{10}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{convert-to-tsibble}{%
\subsubsection{convert to `tsibble'}\label{convert-to-tsibble}}
...
It's now relatively easy and straightforward to make a plot using the key-columns \texttt{flat} and \texttt{sensor}:

\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(ggplot2)}

\KeywordTok{ggplot}\NormalTok{(tsbl, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{ time, }\DataTypeTok{y=}\NormalTok{ value, }\DataTypeTok{colour =}\NormalTok{ flat)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{alpha=}\FloatTok{0.4}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\StringTok{ }\NormalTok{sensor,  }\DataTypeTok{scales=}\StringTok{"free"}\NormalTok{, }\DataTypeTok{ncol =} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{edar_files/figure-latex/tidyData14-1.pdf}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(timestamp, Adr01_energyHeat, Adr02_energyHeat, Adr03_energyHeat)}
\CommentTok{#df <- df %>% filter(timestamp > "2014-12-01")}

\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{FlatA =} \KeywordTok{lead}\NormalTok{(Adr01_energyHeat) }\OperatorTok{-}\StringTok{ }\NormalTok{Adr01_energyHeat)}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{FlatB =} \KeywordTok{lead}\NormalTok{(Adr02_energyHeat) }\OperatorTok{-}\StringTok{ }\NormalTok{Adr02_energyHeat)}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{FlatC =} \KeywordTok{lead}\NormalTok{(Adr03_energyHeat) }\OperatorTok{-}\StringTok{ }\NormalTok{Adr03_energyHeat)}

\CommentTok{# remove counter value column}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{Adr01_energyHeat, }\OperatorTok{-}\NormalTok{Adr02_energyHeat, }\OperatorTok{-}\NormalTok{Adr03_energyHeat) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{()}
...
\NormalTok{tsd <-}\StringTok{ }\KeywordTok{ts}\NormalTok{(df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{timestamp), }\DataTypeTok{frequency =} \DecValTok{12}\NormalTok{, }\DataTypeTok{start =} \KeywordTok{min}\NormalTok{(}\KeywordTok{year}\NormalTok{(df}\OperatorTok{$}\NormalTok{timestamp)))}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{edar_files/figure-latex/eda qda simple ts-1.pdf}
...
\includegraphics{edar_files/figure-latex/eda qda all ts-1.pdf}
...
\includegraphics{edar_files/figure-latex/eda qda indexed ts-1.pdf}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/boxplot0-1} \caption{Room Temperature Raw Data for Boxplot}\label{fig:boxplot0}
\end{figure}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(time, FlatA_Temp, FlatB_Temp, FlatC_Temp, FlatD_Temp)}

\NormalTok{df <-}\StringTok{ }\KeywordTok{as.data.frame}\NormalTok{(tidyr}\OperatorTok{::}\KeywordTok{pivot_longer}\NormalTok{(df,}
                                        \DataTypeTok{cols =} \OperatorTok{-}\NormalTok{time,}
                                        \DataTypeTok{names_to =} \StringTok{"room"}\NormalTok{,}
                                        \DataTypeTok{values_to =} \StringTok{"Temp"}\NormalTok{,}
                                        \DataTypeTok{values_drop_na =} \OtherTok{TRUE}\NormalTok{))}

\NormalTok{minY <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{min}\NormalTok{(df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(Temp), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{-}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{digits =} \DecValTok{0}\NormalTok{)}
\NormalTok{maxY <-}\StringTok{ }\KeywordTok{round}\NormalTok{(}\KeywordTok{max}\NormalTok{(df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(Temp), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{+}\StringTok{ }\DecValTok{1}\NormalTok{, }\DataTypeTok{digits =} \DecValTok{0}\NormalTok{)}


\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ room, }\DataTypeTok{y =}\NormalTok{ Temp)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_boxplot}\NormalTok{(}\DataTypeTok{outlier.alpha =} \FloatTok{0.01}\NormalTok{, }\DataTypeTok{outlier.shape =} \DecValTok{1}\NormalTok{, }\DataTypeTok{outlier.colour =} \StringTok{"darkgrey"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{limits=}\KeywordTok{c}\NormalTok{(minY,maxY), }\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(minY, maxY, }\DataTypeTok{by =} \DecValTok{2}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Boxplot per Flat/Room"}\NormalTok{) }\OperatorTok{+}
...
\NormalTok{yaxis <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}
  \DataTypeTok{title =} \StringTok{"Temp<sub>Room</sub> in \textbackslash{}u00B0C}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
  \DataTypeTok{automargin =} \OtherTok{TRUE}\NormalTok{,}
...
\KeywordTok{ggplotly}\NormalTok{(plot }\OperatorTok{+}\StringTok{ }\KeywordTok{ylab}\NormalTok{(}\StringTok{" "}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{xlab}\NormalTok{(}\StringTok{" "}\NormalTok{)) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{layout}\NormalTok{(}\DataTypeTok{yaxis =}\NormalTok{ yaxis)}
\end{Highlighting}
\end{Shaded}

\includegraphics{edar_files/figure-latex/boxplot2-1.pdf}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/crossCorrelation0-1} \caption{Raw Data Room and Outdoor Temperature for Cross Correlation Plot}\label{fig:crossCorrelation0-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/crossCorrelation0-2} \caption{Raw Data Room and Outdoor Temperature for Cross Correlation Plot}\label{fig:crossCorrelation0-2}
\end{figure}
...
\NormalTok{dfTempOa}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{cut}\NormalTok{(dfTempOa}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"days"}\NormalTok{))}

\NormalTok{dfTempOa <-}\StringTok{ }\NormalTok{dfTempOa }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{tempOa =} \KeywordTok{mean}\NormalTok{(centralOutsideTemp, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}
...
\NormalTok{dfTempR}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{cut}\NormalTok{(dfTempR}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"days"}\NormalTok{))}

\NormalTok{dfTempR <-}\StringTok{ }\NormalTok{dfTempR }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{tempR =} \KeywordTok{mean}\NormalTok{(FlatA_Temp, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}
...
\NormalTok{data}\OperatorTok{$}\NormalTok{season <-}\StringTok{ }\NormalTok{redutils}\OperatorTok{::}\KeywordTok{getSeason}\NormalTok{(data}\OperatorTok{$}\NormalTok{day)}

\NormalTok{data <-}\StringTok{ }\NormalTok{data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(season }\OperatorTok{==}\StringTok{ "Summer"}\NormalTok{)}

\CommentTok{# plot diagram}
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggCcf}\NormalTok{(data}\OperatorTok{$}\NormalTok{tempOa,}
\NormalTok{              data}\OperatorTok{$}\NormalTok{tempR,}
              \DataTypeTok{lag.max =} \DecValTok{7}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{7}\NormalTok{, }\DecValTok{0}\NormalTok{), }\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\OperatorTok{-}\DecValTok{7}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{), }\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(}\OperatorTok{-}\DecValTok{1}\NormalTok{,}\DecValTok{1}\NormalTok{,}\FloatTok{0.2}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{title=}\StringTok{"Cross Correlation between }\CharTok{\textbackslash{}n}\StringTok{ Indoor and Outdoor Temperature in Summer"}\NormalTok{,}
        \DataTypeTok{x =}\StringTok{"Days (Lag)"}\NormalTok{, }\DataTypeTok{y =} \StringTok{"Correlation"}\NormalTok{)}
...
\includegraphics{edar_files/figure-latex/crossCorrelation2-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# save static plot as png (optional)}
\KeywordTok{ggsave}\NormalTok{(}\StringTok{"images/crossCorrelation.png"}\NormalTok{, plot)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/densityplot0-1} \caption{Raw Data Temperature for Density Plot}\label{fig:densityplot0}
\end{figure}
\newpage
...
\KeywordTok{colnames}\NormalTok{(df) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"value"}\NormalTok{)}

\CommentTok{# static chart with ggplot}
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ value)) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_density}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_vline}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{xintercept =} \KeywordTok{mean}\NormalTok{(value, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)),}
             \DataTypeTok{color =} \StringTok{"orange"}\NormalTok{,}
             \DataTypeTok{linetype =} \StringTok{"dashed"}\NormalTok{,}
             \DataTypeTok{size =} \DecValTok{1}\NormalTok{,}
             \DataTypeTok{label =} \StringTok{"Mean"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Density Plot of Room Temperature"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Temperature (\textbackslash{}u00B0C)"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Density (-)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{()}

\CommentTok{# interactive chart}
\NormalTok{plotly}\OperatorTok{::}\KeywordTok{ggplotly}\NormalTok{(plot)}
\end{Highlighting}
\end{Shaded}

\includegraphics{edar_files/figure-latex/densityplot2-1.pdf}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/densityplotSeasons0-1} \caption{Raw Data Temperature for Density Plot}\label{fig:densityplotSeasons0}
\end{figure}
\newpage
...
\NormalTok{df}\OperatorTok{$}\NormalTok{season =}\StringTok{ }\KeywordTok{getSeason}\NormalTok{(df}\OperatorTok{$}\NormalTok{time)}

\CommentTok{# static chart with ggplot}
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(df) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_density}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ value, }\DataTypeTok{colour =}\NormalTok{ season)) }\OperatorTok{+}
...
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Density Plot of Room Temperature for each season of the year"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"Temperature (\textbackslash{}u00B0C)"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Density (-)"}\NormalTok{,}
       \DataTypeTok{colour =} \StringTok{"Legend"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{()}
...
\includegraphics{edar_files/figure-latex/densityplotSeasons2-1.pdf}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisDecompositionLong0-1} \caption{Raw Data for Decomposition Plot Long Term}\label{fig:dataVisDecompositionLong0}
\end{figure}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{value =} \KeywordTok{lead}\NormalTok{(meterValue) }\OperatorTok{-}\StringTok{ }\NormalTok{meterValue)}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisDecompositionShort0-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisDecompositionShort0}
\end{figure}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{value =}\NormalTok{ (meterValue }\OperatorTok{-}\StringTok{ }\KeywordTok{lag}\NormalTok{(meterValue))}\OperatorTok{*}\DecValTok{4}\NormalTok{) }\OperatorTok{%>%}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{component =} \KeywordTok{recode}\NormalTok{(component,}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/seasonalPlotXY0-1} \caption{Raw Data for Seasonal Plot Overlapping}\label{fig:seasonalPlotXY0}
\end{figure}
...
\CommentTok{# remove counter value column and calculate consumption per day instead of month}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{meterValue) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{value =}\NormalTok{ value }\OperatorTok{/}\NormalTok{lubridate}\OperatorTok{::}\KeywordTok{days_in_month}\NormalTok{(timestamp))}

\CommentTok{# value correction (outlier because of commissioning)}
\NormalTok{df[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{] <-}\StringTok{ }\DecValTok{19}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/seasonalMiniplots0-1} \caption{Raw Data for Seasonal Miniplots}\label{fig:seasonalMiniplots0}
\end{figure}
...
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggmonthplot}\NormalTok{(df.ts,}
                    ...
                    \DataTypeTok{ylab =} \StringTok{"Average Daily Energy Consumption per Month }\CharTok{\textbackslash{}n}\StringTok{(kWh/day)}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/seasonalPlotPolar00-1} \caption{Raw Data for Seasonal Plot Polar}\label{fig:seasonalPlotPolar00}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/energyConsBeforeAfter0-1} \caption{Raw Data for Seasonal Plot Overlapping Before/After Optimization}\label{fig:energyConsBeforeAfter0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisHeatmapCalendar1-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisHeatmapCalendar1}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisHeatmapMedianWeeks0-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisHeatmapMedianWeeks0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisDailyProfilesOverview0-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisDailyProfilesOverview0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotDailyProfOverlayed} \caption{Overlayed Daily Profiles}\label{fig:unnamed-chunk-23}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisDailyProfilesOverlayed0-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisDailyProfilesOverlayed0}
\end{figure}
...
\NormalTok{plot <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotDailyProfMean} \caption{Mean Daily Profiles per Weekday}\label{fig:unnamed-chunk-24}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisDailyProfilesMean0-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisDailyProfilesMean0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/dataVisDailyProfilesDecomposed0-1} \caption{Raw Data for Decomposition Plot Short Term}\label{fig:dataVisDailyProfilesDecomposed0}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/sumfrequencydays0-1} \caption{Outside Temperature Raw Data for Sum Frequency Days Plot}\label{fig:sumfrequencydays0}
\end{figure}
...
\NormalTok{df}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{cut}\NormalTok{(df}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"day"}\NormalTok{))}
\NormalTok{df}\OperatorTok{$}\NormalTok{year <-}\StringTok{ }\KeywordTok{year}\NormalTok{(df}\OperatorTok{$}\NormalTok{time)}

\CommentTok{# filter year}
\NormalTok{filterYear <-}\StringTok{ "2019"}

\NormalTok{df <-}\StringTok{ }\KeywordTok{filter}\NormalTok{(df, year }\OperatorTok{==}\StringTok{ }\NormalTok{filterYear)}

\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanValue =} \KeywordTok{mean}\NormalTok{(value, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}

\CommentTok{# Fill missing values with NA}
\NormalTok{grid.df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{day =} \KeywordTok{seq}\NormalTok{(}\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(filterYear, }\StringTok{"-01-01"}\NormalTok{)),}
                                \KeywordTok{as.Date}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(filterYear, }\StringTok{"-12-31"}\NormalTok{)),}
                                 \DataTypeTok{by =} \StringTok{"days"}\NormalTok{))}
\NormalTok{df <-}\StringTok{ }\KeywordTok{merge}\NormalTok{(df, grid.df, }\DataTypeTok{all =} \OtherTok{TRUE}\NormalTok{)}

\CommentTok{# replace NA with interpolation}
\NormalTok{df}\OperatorTok{$}\NormalTok{meanValue <-}\StringTok{ }\KeywordTok{na.approx}\NormalTok{(df}\OperatorTok{$}\NormalTok{meanValue)}

\NormalTok{tempMin <-}\StringTok{ }\KeywordTok{floor}\NormalTok{(}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{meanValue, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}
\NormalTok{tempMax <-}\StringTok{ }\KeywordTok{ceiling}\NormalTok{(}\KeywordTok{max}\NormalTok{(df}\OperatorTok{$}\NormalTok{meanValue, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}

\CommentTok{# create new data frame with sorted values}
\NormalTok{data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{sort}\NormalTok{(df}\OperatorTok{$}\NormalTok{meanValue))}
\NormalTok{data}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{row.names}\NormalTok{(data))}
\KeywordTok{colnames}\NormalTok{(data) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"meanValue"}\NormalTok{, }\StringTok{"day"}\NormalTok{)}

\CommentTok{# static chart with ggplot}
\NormalTok{plot <-}\StringTok{ }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{(data) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ day,}
                          \DataTypeTok{y =}\NormalTok{ meanValue),}
                      \DataTypeTok{colour =} \StringTok{"orange"}\NormalTok{,}
                      \DataTypeTok{alpha =} \FloatTok{0.8}\NormalTok{,}
                      \DataTypeTok{size =} \FloatTok{0.5}
\NormalTok{                      ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Sum Frequency Plot for each Day in a Year"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Mean Temperature (\textbackslash{}u00B0C)}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{Frequency (days)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{append}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{365}\NormalTok{, }\DecValTok{25}\NormalTok{), }\DecValTok{365}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(tempMin, tempMax, }\DecValTok{2}\NormalTok{))}
...
\includegraphics{edar_files/figure-latex/sumfrequencydays2-1.pdf}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/sumfrequencyhour0-1} \caption{Outside Temperature Raw Data for Sum Frequency Hours Plot}\label{fig:sumfrequencyhour0}
\end{figure}
...
\NormalTok{df}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(}\KeywordTok{cut}\NormalTok{(df}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"day"}\NormalTok{))}
\NormalTok{df}\OperatorTok{$}\NormalTok{hour <-}\StringTok{ }\KeywordTok{as.POSIXct}\NormalTok{(}\KeywordTok{cut}\NormalTok{(df}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"hour"}\NormalTok{), }\DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{)}
\NormalTok{df}\OperatorTok{$}\NormalTok{year <-}\StringTok{ }\KeywordTok{year}\NormalTok{(df}\OperatorTok{$}\NormalTok{time)}

\CommentTok{# filter year}

\CommentTok{# edit year!!!}
\NormalTok{filterYear <-}\StringTok{ "2019"}
...
\CommentTok{# Fill missing values with NA}
\NormalTok{grid.df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{hour =} \KeywordTok{seq}\NormalTok{(}\KeywordTok{as.POSIXct}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(filterYear, }\StringTok{"-01-01 00:00:00"}\NormalTok{),}
                                            \DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{),}
                                 \KeywordTok{as.POSIXct}\NormalTok{(}\KeywordTok{paste0}\NormalTok{(filterYear, }\StringTok{"-12-31 23:00:00"}\NormalTok{),}
                                            \DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{),}
                                 \DataTypeTok{by =} \StringTok{"hours"}\NormalTok{))}
\NormalTok{df <-}\StringTok{ }\KeywordTok{merge}\NormalTok{(df, grid.df, }\DataTypeTok{all =} \OtherTok{TRUE}\NormalTok{)}
...
\CommentTok{# create new data frame with sorted values}
\NormalTok{data <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{sort}\NormalTok{(df}\OperatorTok{$}\NormalTok{meanValue))}
\NormalTok{data}\OperatorTok{$}\NormalTok{hour <-}\StringTok{ }\KeywordTok{as.numeric}\NormalTok{(}\KeywordTok{row.names}\NormalTok{(data))}
\KeywordTok{colnames}\NormalTok{(data) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"meanValue"}\NormalTok{, }\StringTok{"hour"}\NormalTok{)}

\CommentTok{# static chart with ggplot}
\NormalTok{plot <-}\StringTok{ }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{ggplot}\NormalTok{(data) }\OperatorTok{+}
\StringTok{  }\NormalTok{ggplot2}\OperatorTok{::}\KeywordTok{geom_point}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ hour,}
                          \DataTypeTok{y =}\NormalTok{ meanValue),}
                      \DataTypeTok{colour =} \StringTok{"orange"}\NormalTok{,}
                      \DataTypeTok{alpha =} \FloatTok{0.3}\NormalTok{,}
                      \DataTypeTok{size =} \FloatTok{0.5}
\NormalTok{                      ) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Sum Frequency Plot for each Hour in a Year"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Mean Temperature (\textbackslash{}u00B0C)}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"}\CharTok{\textbackslash{}n}\StringTok{Frequency (hours)"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{() }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{append}\NormalTok{(}\KeywordTok{seq}\NormalTok{(}\DecValTok{0}\NormalTok{, }\DecValTok{8760}\NormalTok{, }\DecValTok{1000}\NormalTok{), }\DecValTok{8760}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(tempMin, tempMax, }\DecValTok{2}\NormalTok{))}
...
\includegraphics{edar_files/figure-latex/sumfrequencyhour2-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# save static plot as png}
\KeywordTok{ggsave}\NormalTok{(}\StringTok{"images/plotSumFrequencyHour.png"}\NormalTok{, plot)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/mollierhx0-1} \caption{Raw Data Temperature and Humidity for Mollier hx Diagram}\label{fig:mollierhx0-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/mollierhx0-2} \caption{Raw Data Temperature and Humidity for Mollier hx Diagram}\label{fig:mollierhx0-2}
\end{figure}
...
\NormalTok{data <-}\StringTok{ }\NormalTok{data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{tempMean =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(FlatA_Temp)),}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/comforttemphum0-1} \caption{Raw Data Temperature and Humidity for Temp vs. Hum Comfort Plot}\label{fig:comforttemphum0-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/comforttemphum0-2} \caption{Raw Data Temperature and Humidity for Temp vs. Hum Comfort Plot}\label{fig:comforttemphum0-2}
\end{figure}
...
\CommentTok{# select temperature and humidity and remove empty cells}
\NormalTok{data <-}\StringTok{ }\NormalTok{data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(time, FlatA_Temp, FlatA_Hum) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{na.omit}\NormalTok{()}
\KeywordTok{colnames}\NormalTok{(data) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"time"}\NormalTok{, }\StringTok{"tempRaw"}\NormalTok{, }\StringTok{"humidityRaw"}\NormalTok{)}
...
\NormalTok{data <-}\StringTok{ }\NormalTok{data }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{temperature =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(tempRaw), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
                   \DataTypeTok{humidity =} \KeywordTok{mean}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(humidityRaw), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
\NormalTok{  ) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{na.omit}\NormalTok{()}

\CommentTok{# calculate season}
\NormalTok{data}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{parse_date_time}\NormalTok{(data}\OperatorTok{$}\NormalTok{day, }\StringTok{"Ymd"}\NormalTok{, }\DataTypeTok{tz =} \StringTok{"Europe/Zurich"}\NormalTok{)}
\NormalTok{data}\OperatorTok{$}\NormalTok{season <-}\StringTok{ }\KeywordTok{getSeason}\NormalTok{(data}\OperatorTok{$}\NormalTok{day)}

\CommentTok{# create plot}
\CommentTok{# axis properties}
\NormalTok{minx <-}\StringTok{ }\KeywordTok{floor}\NormalTok{(}\KeywordTok{min}\NormalTok{(}\FloatTok{14.0}\NormalTok{,}\KeywordTok{min}\NormalTok{(data}\OperatorTok{$}\NormalTok{temperature)))}
\NormalTok{maxx <-}\StringTok{ }\KeywordTok{ceiling}\NormalTok{(}\KeywordTok{max}\NormalTok{(}\FloatTok{28.0}\NormalTok{,}\KeywordTok{max}\NormalTok{(data}\OperatorTok{$}\NormalTok{temperature)))}
\NormalTok{miny <-}\StringTok{ }\FloatTok{0.0}
\NormalTok{maxy <-}\StringTok{ }\FloatTok{100.0}

\CommentTok{# comfort zones}
\NormalTok{df.zoneNotComfortable <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Temp =} \KeywordTok{c}\NormalTok{(minx,minx,maxx, maxx, minx),}
                                    \DataTypeTok{Hum =} \KeywordTok{c}\NormalTok{(miny,maxy,maxy, miny, miny),}
                                    \DataTypeTok{Zones =} \StringTok{"uncomfortable"}\NormalTok{)}
\NormalTok{df.zoneStillComfortable <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Temp =} \KeywordTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{,}\DecValTok{17}\NormalTok{,}\DecValTok{16}\NormalTok{,}\DecValTok{17}\NormalTok{,}\FloatTok{21.5}\NormalTok{,}\DecValTok{25}\NormalTok{,}\DecValTok{27}\NormalTok{,}\FloatTok{25.5}\NormalTok{,}\DecValTok{20}\NormalTok{),}
                                      \DataTypeTok{Hum =} \KeywordTok{c}\NormalTok{(}\DecValTok{20}\NormalTok{,}\DecValTok{40}\NormalTok{,}\DecValTok{75}\NormalTok{,}\DecValTok{85}\NormalTok{,}\DecValTok{80}\NormalTok{,}\DecValTok{60}\NormalTok{,}\DecValTok{30}\NormalTok{,}\DecValTok{20}\NormalTok{,}\DecValTok{20}\NormalTok{),}
                                      \DataTypeTok{Zones =} \StringTok{"Still comfortable"}\NormalTok{)}

\NormalTok{df.zoneComfortable <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Temp =} \KeywordTok{c}\NormalTok{(}\DecValTok{19}\NormalTok{,}\FloatTok{17.5}\NormalTok{,}\FloatTok{22.5}\NormalTok{,}\DecValTok{24}\NormalTok{,}\DecValTok{19}\NormalTok{),}
                                 \DataTypeTok{Hum =} \KeywordTok{c}\NormalTok{(}\DecValTok{38}\NormalTok{,}\DecValTok{74}\NormalTok{,}\DecValTok{65}\NormalTok{,}\DecValTok{35}\NormalTok{,}\DecValTok{38}\NormalTok{),}
                                 \DataTypeTok{Zones =} \StringTok{"Comfortable"}\NormalTok{)}
...
\StringTok{    }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ data,}
             \KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ temperature,}
                 ...
                 \DataTypeTok{text =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"Temp:    "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, temperature),}
                                 \StringTok{"<br />Hum:     "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f %%rH"}\NormalTok{, humidity),}
...
\StringTok{  }\KeywordTok{labs}\NormalTok{(}\DataTypeTok{x =} \StringTok{"}\CharTok{\textbackslash{}n}\StringTok{Temperature (\textbackslash{}u00B0C)"}\NormalTok{,}
       \DataTypeTok{y =} \StringTok{"Humidity (%rH)}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
       \DataTypeTok{fill =} \StringTok{""}\NormalTok{,}
       \DataTypeTok{colour =} \StringTok{"Legend"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_x_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(minx, maxx, }\DecValTok{2}\NormalTok{),}
                     \DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(minx, maxx)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_y_continuous}\NormalTok{(}\DataTypeTok{breaks =} \KeywordTok{seq}\NormalTok{(miny, maxy, }\DecValTok{20}\NormalTok{),}
                     \DataTypeTok{limits =} \KeywordTok{c}\NormalTok{(miny, maxy)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_color_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"#440154"}\NormalTok{, }\StringTok{"#2db27d"}\NormalTok{, }\StringTok{"#febc2b"}\NormalTok{, }\StringTok{"#365c8d"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{scale_fill_manual}\NormalTok{(}\DataTypeTok{values =} \KeywordTok{c}\NormalTok{(}\StringTok{"#440154"}\NormalTok{, }\StringTok{"#2db27d"}\NormalTok{, }\StringTok{"#febc2b"}\NormalTok{, }\StringTok{"#365c8d"}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_minimal}\NormalTok{()}

\CommentTok{# interactive chart}
\KeywordTok{ggplotly}\NormalTok{(plot, }\DataTypeTok{tooltip =} \StringTok{"text"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}

\includegraphics{edar_files/figure-latex/comforttemphum1-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# save static plot as png}
\CommentTok{#ggsave("images/comfortTempHum.png", plot)}
\end{Highlighting}
\end{Shaded}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/comfortSia180ThermCmf0-1} \caption{Raw Data Room and Outdoor Temperature for SIA180 Thermal Comfort Plot}\label{fig:comfortSia180ThermCmf0-1}
\end{figure}
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/comfortSia180ThermCmf0-2} \caption{Raw Data Room and Outdoor Temperature for SIA180 Thermal Comfort Plot}\label{fig:comfortSia180ThermCmf0-2}
\end{figure}
...
\NormalTok{dfTempOa <-}\StringTok{ }\NormalTok{dfTempOa }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(hour) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempMean =} \KeywordTok{mean}\NormalTok{(centralOutsideTemp)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{dfTempOa <-}\StringTok{ }\NormalTok{dfTempOa }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempOa =} \KeywordTok{rollmean}\NormalTok{(tempMean, }\DecValTok{48}\NormalTok{, }\DataTypeTok{fill =} \OtherTok{NA}\NormalTok{, }\DataTypeTok{align =} \StringTok{"right"}\NormalTok{))}
...
\NormalTok{dfTempR <-}\StringTok{ }\NormalTok{dfTempR }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(hour) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempR =} \KeywordTok{mean}\NormalTok{(FlatA_Temp)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
...
\NormalTok{plot <-}\StringTok{ }\NormalTok{data }\OperatorTok{%>%}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/eleHousehold10-1} \caption{Raw Data for Electricity Household Plot}\label{fig:eleHousehold10}
\end{figure}
...
\CommentTok{# convert steadily counting energy meter value from kWh to power in kW}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{value =}\NormalTok{ (meterValue }\OperatorTok{-}\StringTok{ }\KeywordTok{lag}\NormalTok{(meterValue))) }\OperatorTok{%>%}
...
\CommentTok{# tag NA}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{deleteNA =} \KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(value),}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{))}

\CommentTok{# tag values below 0 and higher than 9.2 kW}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{deleteHiLoVal =} \KeywordTok{ifelse}\NormalTok{(value }\OperatorTok{>}\StringTok{ }\FloatTok{9.2}\NormalTok{,}\DecValTok{1}\NormalTok{, }\KeywordTok{ifelse}\NormalTok{(value }\OperatorTok{<}\StringTok{ }\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{0}\NormalTok{)))}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{delete =} \KeywordTok{sum}\NormalTok{(deleteNA, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{+}\StringTok{ }\KeywordTok{sum}\NormalTok{(deleteHiLoVal, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{season =}\NormalTok{ redutils}\OperatorTok{::}\KeywordTok{getSeason}\NormalTok{(timestamp))}
...
You probably noticed the line with the average consumption value. This gets calculated by the recommended values and formulas of the study \href{https://www.aramis.admin.ch/Default.aspx?DocumentID=61764}{Typischer Haushalt-Stromverbrauch - Schlussbericht} by Nipkov, J. (2013)

You can find the implementation in \href{https://smogdr.github.io/edar_coursebook/}{redutils function getTypEleConsHousehold()} where various parameters can get adapted via function call arguments.
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/roomTempRed} \caption{Room Temperature Reduction Plot}\label{fig:unnamed-chunk-33}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/roomTempRed0-1} \caption{Raw Data Temperature for Room Temperature Reduction Plot}\label{fig:roomTempRed0}
\end{figure}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{minDay =} \KeywordTok{min}\NormalTok{(}\KeywordTok{as.numeric}\NormalTok{(FlatA_Temp)),}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{period =} \KeywordTok{ifelse}\NormalTok{(day }\OperatorTok{>=}\StringTok{ }\NormalTok{startDate }\OperatorTok{&}\StringTok{ }\NormalTok{day }\OperatorTok{<=}\StringTok{ }\NormalTok{optiDate1,}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{medianPeriod =} \KeywordTok{ifelse}\NormalTok{(}\KeywordTok{is.na}\NormalTok{(period), }\OtherTok{NA}\NormalTok{, }\KeywordTok{median}\NormalTok{(medianDay))) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{edar_files/figure-latex/energysignature0-1} \caption{Outside Temperature Raw Data for Building Energy Signature Plot}\label{fig:energysignature0}
\end{figure}
...
\NormalTok{dfHeatEnergy <-}\StringTok{ }\NormalTok{dfHeatEnergy }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{energyMax =} \KeywordTok{max}\NormalTok{(energyHeatingMeter)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}
...
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{energyCons =}\NormalTok{ energyMax }\OperatorTok{-}\StringTok{ }\KeywordTok{lag}\NormalTok{(energyMax)) }\OperatorTok{%>%}
...
\CommentTok{# calculate season}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{season =}\NormalTok{ redutils}\OperatorTok{::}\KeywordTok{getSeason}\NormalTok{(df}\OperatorTok{$}\NormalTok{day))}
...
\includegraphics{edar_files/figure-latex/energysignaturepes1-1.pdf} \includegraphics{edar_files/figure-latex/energysignaturepes1-2.pdf} \includegraphics{edar_files/figure-latex/energysignaturepes1-3.pdf}
...
\NormalTok{df.all <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"https://github.com/hslu-ige-laes/edar/raw/master/sampleData/bldgEngySigProposedData.csv"}\NormalTok{,}
                    \DataTypeTok{stringsAsFactors=}\OtherTok{FALSE}\NormalTok{,}
                    \DataTypeTok{sep =}\StringTok{","}\NormalTok{)}

\KeywordTok{names}\NormalTok{(df.all)[}\DecValTok{1}\NormalTok{] <-}\StringTok{ "time"}
\KeywordTok{names}\NormalTok{(df.all)[}\DecValTok{2}\NormalTok{] <-}\StringTok{ "TOa"}
\KeywordTok{names}\NormalTok{(df.all)[}\DecValTok{3}\NormalTok{] <-}\StringTok{ "Energy"}
\KeywordTok{names}\NormalTok{(df.all)[}\DecValTok{4}\NormalTok{] <-}\StringTok{ "TRoom"}

\NormalTok{df.all}\OperatorTok{$}\NormalTok{time <-}\StringTok{ }\KeywordTok{as.POSIXct}\NormalTok{(df.all}\OperatorTok{$}\NormalTok{time, }
                \DataTypeTok{format=}\StringTok{"%Y-%m-%dT%H:%M:%OSZ"}\NormalTok{, }\DataTypeTok{tz=}\StringTok{"Europe/Zurich"}\NormalTok{)}

\NormalTok{df.all <-}\StringTok{ }\NormalTok{df.all }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{season =} \KeywordTok{getSeason}\NormalTok{(time),}
                \DataTypeTok{day =}\NormalTok{ lubridate}\OperatorTok{::}\KeywordTok{date}\NormalTok{(time),}
                \DataTypeTok{month =}\NormalTok{ lubridate}\OperatorTok{::}\KeywordTok{month}\NormalTok{(time),}
                \DataTypeTok{week =}\NormalTok{ lubridate}\OperatorTok{::}\KeywordTok{week}\NormalTok{(time),}
                \DataTypeTok{hour =}\NormalTok{ lubridate}\OperatorTok{::}\KeywordTok{hour}\NormalTok{(time),}
                \DataTypeTok{power =}\NormalTok{ Energy}
\NormalTok{                ) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{na.omit}\NormalTok{()}

\CommentTok{# Initial Balance Temperature Tb}
\NormalTok{Tb <-}\StringTok{ }\DecValTok{12}

\CommentTok{# Initial difference}
\NormalTok{delta <-}\StringTok{ }\DecValTok{1}

\ControlFlowTok{while}\NormalTok{(}\KeywordTok{abs}\NormalTok{(delta) }\OperatorTok{>}\StringTok{ }\FloatTok{0.1}\NormalTok{)\{}
  
  \CommentTok{# calculate standby power pStby}
  \CommentTok{# conditions}
  \CommentTok{# - TOa > Tb}
\NormalTok{  df <-}\StringTok{ }\NormalTok{df.all }\OperatorTok{%>%}\StringTok{ }\KeywordTok{group_by}\NormalTok{(week) }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{keep =}\NormalTok{ (}\KeywordTok{mean}\NormalTok{(TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{>}\StringTok{ }\NormalTok{Tb),}
                  \DataTypeTok{pStby =} \KeywordTok{min}\NormalTok{(power, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{filter}\NormalTok{(keep }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\NormalTok{Energy)}

\NormalTok{  pStby <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(df}\OperatorTok{$}\NormalTok{pStby, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
  
  \CommentTok{# calculate hotwater power pHw}
  \CommentTok{# conditions}
  \CommentTok{# - TOa > Tb}
\NormalTok{    df <-}\StringTok{ }\NormalTok{df.all }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(week) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{keep =}\NormalTok{ (}\KeywordTok{mean}\NormalTok{(TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{>}\StringTok{ }\NormalTok{Tb)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{pHw =} \KeywordTok{mean}\NormalTok{(power, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(keep }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{)}
  
\NormalTok{  pHw <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(df}\OperatorTok{$}\NormalTok{pHw, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{-}\StringTok{ }\NormalTok{pStby}
  
  \CommentTok{# Assumption for internal heat gains}
\NormalTok{  pIhg <-}\StringTok{ }\DecValTok{3}\OperatorTok{*}\DecValTok{90}\OperatorTok{*}\DecValTok{9}\OperatorTok{/}\DecValTok{1000}\OperatorTok{/}\FloatTok{4.5}  \CommentTok{# 3 W/m^2, 90m^2/flat, 9 flats, COP WP 4.5, 24 hours per day}
  
  \CommentTok{# calculate internal heat generation pIhg}
  \CommentTok{# conditions}
  \CommentTok{# - Month is Jan, Feb and March}
  \CommentTok{# - TOa < Tb}
\NormalTok{  df <-}\StringTok{ }\NormalTok{df.all }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(month }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{keep =}\NormalTok{ (}\KeywordTok{max}\NormalTok{(TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{<}\StringTok{ }\NormalTok{Tb)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{filter}\NormalTok{(keep }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{meanPower =} \KeywordTok{mean}\NormalTok{(power, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{meanTOa =} \KeywordTok{mean}\NormalTok{(TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))  }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{meanTRoom =} \KeywordTok{mean}\NormalTok{(TRoom, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}
\StringTok{    }\KeywordTok{select}\NormalTok{(day, meanPower, meanTOa,  meanTRoom, week) }\OperatorTok{%>%}\StringTok{ }
\StringTok{    }\KeywordTok{unique}\NormalTok{()}
  
  \CommentTok{# calculate Building total heat loss coefficient QTot in kW/K}
\NormalTok{  df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}
\StringTok{    }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{QTot =}\NormalTok{ (meanPower }\OperatorTok{-}\StringTok{ }\NormalTok{pStby }\OperatorTok{-}\StringTok{ }\NormalTok{pHw }\OperatorTok{+}\StringTok{ }\NormalTok{pIhg)}\OperatorTok{/}\NormalTok{(meanTRoom }\OperatorTok{-}\StringTok{ }\NormalTok{meanTOa))}
  
\NormalTok{  QTot <-}\StringTok{ }\KeywordTok{mean}\NormalTok{(df}\OperatorTok{$}\NormalTok{QTot, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}

\NormalTok{  result <-}\StringTok{ }\OtherTok{NULL}
  
  \CommentTok{# Iterative determination of balance temperature Tb}
  \ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \KeywordTok{seq}\NormalTok{(}\DecValTok{10}\NormalTok{,}\DecValTok{30}\NormalTok{,}\FloatTok{0.1}\NormalTok{))\{}
\NormalTok{    df.i <-}\StringTok{ }\NormalTok{df.all }\OperatorTok{%>%}
\StringTok{      }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempDiff =}\NormalTok{ i }\OperatorTok{-}\StringTok{ }\NormalTok{TOa) }\OperatorTok{%>%}
\StringTok{      }\KeywordTok{filter}\NormalTok{(tempDiff }\OperatorTok{>}\StringTok{ }\DecValTok{0}\NormalTok{)}
    
\NormalTok{    df.i <-}\StringTok{ }\NormalTok{df.i }\OperatorTok{%>%}\StringTok{ }
\StringTok{      }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{powerCalc =}\NormalTok{ (QTot }\OperatorTok{*}\StringTok{ }\NormalTok{tempDiff }\OperatorTok{+}\StringTok{ }\NormalTok{pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw))}
    
\NormalTok{    percDiff <-}\StringTok{ }\DecValTok{100}\OperatorTok{/}\KeywordTok{sum}\NormalTok{(df.all}\OperatorTok{$}\NormalTok{power, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{) }\OperatorTok{*}\StringTok{ }\KeywordTok{sum}\NormalTok{(df.i}\OperatorTok{$}\NormalTok{powerCalc, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)}
    
\NormalTok{    result =}\StringTok{ }\KeywordTok{rbind}\NormalTok{(result, }\KeywordTok{data.frame}\NormalTok{(}\DataTypeTok{Tb =}\NormalTok{ i,}
                                      \DataTypeTok{percDiff =}\NormalTok{ percDiff,}
                                      \DataTypeTok{power =} \KeywordTok{sum}\NormalTok{(df.all}\OperatorTok{$}\NormalTok{power),}
                                      \DataTypeTok{powerCalc =} \KeywordTok{sum}\NormalTok{(df.i}\OperatorTok{$}\NormalTok{powerCalc)))}
\NormalTok{  \}}
  
\NormalTok{  Tb.new <-}\StringTok{ }\NormalTok{result[}\KeywordTok{which}\NormalTok{(}\KeywordTok{abs}\NormalTok{(result}\OperatorTok{$}\NormalTok{percDiff}\DecValTok{-100}\NormalTok{) }\OperatorTok{==}\StringTok{ }\KeywordTok{min}\NormalTok{(}\KeywordTok{abs}\NormalTok{(result}\OperatorTok{$}\NormalTok{percDiff }\OperatorTok{-}\StringTok{ }\DecValTok{100}\NormalTok{), }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)),}\DecValTok{1}\NormalTok{]}
\NormalTok{  delta <-}\StringTok{ }\NormalTok{Tb }\OperatorTok{-}\StringTok{ }\NormalTok{Tb.new}
\NormalTok{  Tb <-}\StringTok{ }\NormalTok{Tb.new}
...
\NormalTok{df <-}\StringTok{ }\NormalTok{df.all }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{TOaMean =} \KeywordTok{mean}\NormalTok{(TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\NormalTok{dplyr}\OperatorTok{::}\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{powerSum =} \KeywordTok{mean}\NormalTok{(power, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(day, TOaMean, powerSum, season) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{na.omit}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unique}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{ungroup}\NormalTok{()}

\KeywordTok{names}\NormalTok{(df)[}\DecValTok{2}\NormalTok{] <-}\StringTok{ "TOa"}
\KeywordTok{names}\NormalTok{(df)[}\DecValTok{3}\NormalTok{] <-}\StringTok{ "Power"}

\CommentTok{# df <- df %>% dplyr::mutate((EnergyHeat = TOa * -0.04955 + 4.5865) * Energy)}
\CommentTok{# names(df)[5] <- "EnergyHeat"}

\NormalTok{df.fall <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(season}\OperatorTok{==}\StringTok{"Fall"}\NormalTok{)}
\NormalTok{df.winter <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(season}\OperatorTok{==}\StringTok{"Winter"}\NormalTok{)}
\NormalTok{df.spring <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(season}\OperatorTok{==}\StringTok{"Spring"}\NormalTok{)}
\NormalTok{df.summer <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(season}\OperatorTok{==}\StringTok{"Summer"}\NormalTok{)}

\CommentTok{# annotations}
\NormalTok{a_Tb <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ Tb,}
  \DataTypeTok{y =}\NormalTok{ pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw,}
  \DataTypeTok{text =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"Balance Temperature<br> Tb = "}\NormalTok{,}
                \KeywordTok{round}\NormalTok{(Tb, }\DataTypeTok{digits =} \DecValTok{1}\NormalTok{),}
                \StringTok{" \textbackslash{}u00B0C"}
\NormalTok{                ),}
  \DataTypeTok{showarrow =} \OtherTok{TRUE}\NormalTok{,}
  \DataTypeTok{arrowhead =} \DecValTok{7}\NormalTok{,}
  \DataTypeTok{ax =} \DecValTok{70}\NormalTok{,}
  \DataTypeTok{ay =} \DecValTok{-70}
\NormalTok{)}

\NormalTok{a_QTot <-}\StringTok{ }\KeywordTok{list}\NormalTok{(}
  \DataTypeTok{x =}\NormalTok{ (Tb}\OperatorTok{-}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{))}\OperatorTok{/}\DecValTok{2}\OperatorTok{+}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}
  \DataTypeTok{y =}\NormalTok{ (Tb}\OperatorTok{-}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{*}\StringTok{ }\NormalTok{QTot}\OperatorTok{/}\DecValTok{2}\OperatorTok{+}\NormalTok{pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw,}
  \DataTypeTok{text =} \KeywordTok{paste0}\NormalTok{(}\StringTok{"Heat Loss Coefficient<br>QTot = "}\NormalTok{,}
                \KeywordTok{round}\NormalTok{(QTot, }\DataTypeTok{digits =} \DecValTok{3}\NormalTok{),}
                \StringTok{" kW/K"}\NormalTok{),}
  \DataTypeTok{showarrow =} \OtherTok{TRUE}\NormalTok{,}
  \DataTypeTok{arrowhead =} \DecValTok{2}\NormalTok{,}
  \DataTypeTok{ax =} \DecValTok{120}\NormalTok{,}
  \DataTypeTok{ay =} \DecValTok{-50}
\NormalTok{)}

\CommentTok{# Create plot}
\NormalTok{p <-}\StringTok{ }\KeywordTok{plot_ly}\NormalTok{()}

\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_lines}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, Tb, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{),}\KeywordTok{max}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)),}
                     \DataTypeTok{y =} \KeywordTok{rep}\NormalTok{((pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw), }\DecValTok{2}\NormalTok{),}
                     \DataTypeTok{name =} \StringTok{"Base Load + Standby"}\NormalTok{,}
                     \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
                     \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Base Load + Standby:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.3f kW"}\NormalTok{, pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw)}
\NormalTok{                     ))}
\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_lines}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, Tb, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{), }\KeywordTok{max}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)),}
                     \DataTypeTok{y =} \KeywordTok{rep}\NormalTok{(pStby, }\DecValTok{2}\NormalTok{),}
                     \DataTypeTok{name =} \StringTok{"Standby"}\NormalTok{,}
                     \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
                     \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Standby:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.3f kW"}\NormalTok{, pStby)}
\NormalTok{                     ))}
\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_lines}\NormalTok{(}\DataTypeTok{x =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{), Tb),}
                     \DataTypeTok{y =} \KeywordTok{c}\NormalTok{((Tb}\OperatorTok{-}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{TOa, }\DataTypeTok{na.rm =} \OtherTok{TRUE}\NormalTok{)) }\OperatorTok{*}\StringTok{ }\NormalTok{QTot }\OperatorTok{+}\StringTok{ }\NormalTok{pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw, pStby }\OperatorTok{+}\StringTok{ }\NormalTok{pHw), }\DataTypeTok{name =} \StringTok{"Heating"}\NormalTok{)}

\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_markers}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.spring,}
                       \DataTypeTok{x =} \OperatorTok{~}\NormalTok{TOa,}
                       \DataTypeTok{y =} \OperatorTok{~}\NormalTok{Power,}
                       \DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{"#2db27d"}\NormalTok{, }\DataTypeTok{opacity =} \FloatTok{0.3}\NormalTok{),}
                       \DataTypeTok{name =} \StringTok{"Spring"}\NormalTok{,}
                       \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
                       \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Outside Temp:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, TOa),}
                                      \StringTok{"<br />Power:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f kW"}\NormalTok{, Power),}
                                      \StringTok{"<br />Date:     "}\NormalTok{, day,}
                                      \StringTok{"<br />Season: "}\NormalTok{, df.spring}\OperatorTok{$}\NormalTok{season}
\NormalTok{                       )}
\NormalTok{  )}

\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_markers}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.summer,}
                       \DataTypeTok{x =} \OperatorTok{~}\NormalTok{TOa,}
                       \DataTypeTok{y =} \OperatorTok{~}\NormalTok{Power,}
                       \DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{"#fde725"}\NormalTok{, }\DataTypeTok{opacity =} \FloatTok{0.3}\NormalTok{),}
                       \DataTypeTok{name =} \StringTok{"Summer"}\NormalTok{,}
                       \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
                       \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Outside Temp:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, TOa),}
                                      \StringTok{"<br />Power:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f kW"}\NormalTok{, Power),}
                                      \StringTok{"<br />Date:     "}\NormalTok{, day,}
                                      \StringTok{"<br />Season: "}\NormalTok{, df.summer}\OperatorTok{$}\NormalTok{season}
\NormalTok{                       )}
\NormalTok{  )}


\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_markers}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.fall,}
                       \DataTypeTok{x =} \OperatorTok{~}\NormalTok{TOa,}
                       \DataTypeTok{y =} \OperatorTok{~}\NormalTok{Power,}
                       \DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{"#440154"}\NormalTok{, }\DataTypeTok{opacity =} \FloatTok{0.3}\NormalTok{),}
                       \DataTypeTok{name =} \StringTok{"Fall"}\NormalTok{,}
                       \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
                       \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Outside Temp:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, TOa),}
                                      \StringTok{"<br />Power:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f kW"}\NormalTok{, Power),}
                                      \StringTok{"<br />Date:     "}\NormalTok{, day,}
                                      \StringTok{"<br />Season: "}\NormalTok{, df.fall}\OperatorTok{$}\NormalTok{season}
\NormalTok{                       )}
\NormalTok{  )}

\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}\StringTok{ }\KeywordTok{add_markers}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.winter,}
                       \DataTypeTok{x =} \OperatorTok{~}\NormalTok{TOa,}
                       \DataTypeTok{y =} \OperatorTok{~}\NormalTok{Power,}
                       \DataTypeTok{marker =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{color =} \StringTok{"#365c8d"}\NormalTok{, }\DataTypeTok{opacity =} \FloatTok{0.3}\NormalTok{),}
                       \DataTypeTok{name =} \StringTok{"Winter"}\NormalTok{,}
                       \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
                       \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Outside Temp:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, TOa),}
                                      \StringTok{"<br />Power:  "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f kW"}\NormalTok{, Power),}
                                      \StringTok{"<br />Date:     "}\NormalTok{, day,}
                                      \StringTok{"<br />Season: "}\NormalTok{, df.winter}\OperatorTok{$}\NormalTok{season}
\NormalTok{                       )}
\NormalTok{  )}

\NormalTok{p <-}\StringTok{ }\NormalTok{p }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{layout}\NormalTok{(}
    \DataTypeTok{xaxis =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Outside temperature (\textbackslash{}u00B0C)"}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(}\OperatorTok{-}\DecValTok{10}\NormalTok{,}\KeywordTok{min}\NormalTok{(df.all}\OperatorTok{$}\NormalTok{TOa)), }\KeywordTok{max}\NormalTok{(}\DecValTok{35}\NormalTok{,}\KeywordTok{max}\NormalTok{(df.all}\OperatorTok{$}\NormalTok{TOa))), }\DataTypeTok{zeroline =}\NormalTok{ F),}
    \DataTypeTok{yaxis =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Power (kW)"}\NormalTok{, }\DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(df}\OperatorTok{$}\NormalTok{Power, }\KeywordTok{max}\NormalTok{(df}\OperatorTok{$}\NormalTok{Power)))),}
    \DataTypeTok{showlegend =} \OtherTok{TRUE}\NormalTok{,}
    \DataTypeTok{legend =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{orientation =} \StringTok{"h"}\NormalTok{,}
                  \DataTypeTok{y =} \FloatTok{-0.2}\NormalTok{,}
                  \DataTypeTok{x =} \DecValTok{0}\NormalTok{),}
    \DataTypeTok{annotations =} \KeywordTok{list}\NormalTok{(a_Tb,a_QTot)}
\NormalTok{  ) }\OperatorTok{%>%}
\StringTok{  }\NormalTok{plotly}\OperatorTok{::}\KeywordTok{config}\NormalTok{(}\DataTypeTok{modeBarButtons =} \KeywordTok{list}\NormalTok{(}\KeywordTok{list}\NormalTok{(}\StringTok{"toImage"}\NormalTok{)), }\DataTypeTok{displaylogo =} \OtherTok{FALSE}\NormalTok{)}
...
\includegraphics{edar_files/figure-latex/energysignaturepes2-1.pdf}
...
\hypertarget{plotly-multiple-y-axis}{%
\section{Plotly Multiple Y Axis}\label{plotly-multiple-y-axis}}
...
\CommentTok{# create plot}
\CommentTok{# axis properties}
\NormalTok{minyaxis1 <-}\StringTok{ }\KeywordTok{floor}\NormalTok{(}\KeywordTok{min}\NormalTok{(}\FloatTok{14.0}\NormalTok{,}\KeywordTok{min}\NormalTok{(data}\OperatorTok{$}\NormalTok{temperature)))}
\NormalTok{maxyaxis1 <-}\StringTok{ }\KeywordTok{ceiling}\NormalTok{(}\KeywordTok{max}\NormalTok{(}\FloatTok{28.0}\NormalTok{,}\KeywordTok{max}\NormalTok{(data}\OperatorTok{$}\NormalTok{temperature)))}
\NormalTok{minyaxis2 <-}\StringTok{ }\FloatTok{0.0}
\NormalTok{maxyaxis2 <-}\StringTok{ }\FloatTok{100.0}

\NormalTok{dateRange <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\KeywordTok{min}\NormalTok{(data}\OperatorTok{$}\NormalTok{time), }\KeywordTok{max}\NormalTok{(data}\OperatorTok{$}\NormalTok{time))}
\NormalTok{plotColors <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"darkgreen"}\NormalTok{, }\StringTok{"orange"}\NormalTok{)}
\NormalTok{pAxisSpacer <-}\StringTok{ }\FloatTok{0.07}
...
\StringTok{  }\KeywordTok{layout}\NormalTok{(}
    ...
    \DataTypeTok{yaxis =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{title =} \StringTok{'Temperature'}\NormalTok{, }
                 ...
                 \DataTypeTok{anchor =} \StringTok{'free'}\NormalTok{, }
                 \DataTypeTok{zeroline =}\NormalTok{ F, }
                 \DataTypeTok{showline =}\NormalTok{ T),}
    \DataTypeTok{yaxis2 =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{title =} \StringTok{'Humidity'}\NormalTok{, }
                  \DataTypeTok{side =} \StringTok{"left"}\NormalTok{,}
                  \DataTypeTok{color =}\NormalTok{ plotColors[}\DecValTok{2}\NormalTok{],}
                  \DataTypeTok{range =} \KeywordTok{c}\NormalTok{(minyaxis2,maxyaxis2), }
                  \DataTypeTok{ticks=}\StringTok{'outside'}\NormalTok{, }
                  \DataTypeTok{dtick =} \DecValTok{10}\NormalTok{, }
                  \DataTypeTok{tick0 =}\NormalTok{ minyaxis2, }
                  \DataTypeTok{tickmode =} \StringTok{"linear"}\NormalTok{, }
                  \DataTypeTok{position =}\NormalTok{ pAxisSpacer, }
                  \DataTypeTok{overlaying =} \StringTok{"y"}\NormalTok{,}
                  \DataTypeTok{anchor =} \StringTok{'free'}\NormalTok{,}
                  \DataTypeTok{zeroline=}\NormalTok{F, }
                  \DataTypeTok{showline =}\NormalTok{ T),}
    \DataTypeTok{legend =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{x=}\NormalTok{pAxisSpacer}\OperatorTok{*}\FloatTok{3.5}\NormalTok{, }\DataTypeTok{y=} \DecValTok{1}\NormalTok{), }
    \DataTypeTok{showlegend =}\NormalTok{ T,}
    \DataTypeTok{title =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{text =} \StringTok{"Ploty plot with multiple y axis"}\NormalTok{)}
\NormalTok{  )}
\NormalTok{plot}
\end{Highlighting}
\end{Shaded}

\includegraphics{edar_files/figure-latex/plotlymultipleyaxis1-1.pdf}
