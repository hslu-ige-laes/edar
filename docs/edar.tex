...
\hypertarget{seasonal-plot---xy}{%
\section{Seasonal Plot - x/y}\label{seasonal-plot---xy}}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotSeasonalXY} \caption{Seasonal Plot x/y per Month over 10 Years}\label{fig:unnamed-chunk-4}
\end{figure}
...
\hypertarget{seasonal-plot---monthplot}{%
\section{Seasonal Plot - Monthplot}\label{seasonal-plot---monthplot}}

\hypertarget{task-2}{%
\subsection{Task}\label{task-2}}

\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotSeasonalMonth} \caption{Seasonal Plot x/y per Month over 10 Years}\label{fig:unnamed-chunk-5}
\end{figure}
...
\CommentTok{# filter flat}
\NormalTok{df <-}\StringTok{ }\NormalTok{df }\OperatorTok{%>%}\StringTok{ }\KeywordTok{select}\NormalTok{(timestamp, Adr01_energyHeat)}
...
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggmonthplot}\NormalTok{(df.ts,}
                    \DataTypeTok{col =} \KeywordTok{viridis}\NormalTok{(numYears),}
                    \DataTypeTok{main =} \StringTok{"Seasonal Month-Plot over 10 years}\CharTok{\textbackslash{}n}\StringTok{"}\NormalTok{,}
...
\includegraphics{edar_files/figure-latex/seasonalPlotMonth1-1.pdf}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# save static plot as png}
\KeywordTok{ggsave}\NormalTok{(}\StringTok{"images/plotSeasonalMonth.png"}\NormalTok{, plot)}
\end{Highlighting}
\end{Shaded}
...
\CommentTok{# save interactive plot as html}
\KeywordTok{library}\NormalTok{(htmlwidgets)}
\NormalTok{htmlwidgets}\OperatorTok{::}\KeywordTok{saveWidget}\NormalTok{(plotly, }\StringTok{"plotlySeasonalMonth.html"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{seasonal-plot---polar}{%
\section{Seasonal Plot - Polar}\label{seasonal-plot---polar}}

\hypertarget{task-3}{%
\subsection{Task}\label{task-3}}

Plot a seasonal polar plot as described in Hyndman and Athanasopoulos (2014, chapter 2). This is like a time plot except that the data are plotted against the seasons in separate years.
...
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggseasonplot}\NormalTok{(df.ts,}
                     \DataTypeTok{col =} \KeywordTok{viridis}\NormalTok{(numYears),}
                     \DataTypeTok{main =} \StringTok{"Seasonal Plot Polar per Month over 10 Years"}\NormalTok{,}
                     \DataTypeTok{ylab =} \StringTok{"Energy Consumption (kWh/month)"}\NormalTok{,}
                     \DataTypeTok{polar =} \OtherTok{TRUE}
\NormalTok{                     )}

\CommentTok{# show plot (interactive version with plotly not possible)}
\NormalTok{plot}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{seasonal-plot---xy-beforeafter}{%
\section{Seasonal Plot - x/y Before/After}\label{seasonal-plot---xy-beforeafter}}

\hypertarget{task-4}{%
\subsection{Task}\label{task-4}}

\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotEnergyConsBeforeAfter} \caption{Seasonal Plot x/y Before/After}\label{fig:unnamed-chunk-7}
\end{figure}
...
\hypertarget{decomposition---long-term}{%
\section{Decomposition - Long term}\label{decomposition---long-term}}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{ggplot}\NormalTok{(data) }\OperatorTok{+}
...
\hypertarget{decomposition---short-term}{%
\section{Decomposition - Short term}\label{decomposition---short-term}}
...
\hypertarget{heatmap-median-weeks}{%
\section{Heatmap Median-Weeks}\label{heatmap-median-weeks}}
...
\hypertarget{heatmap-calendar}{%
\section{Heatmap Calendar}\label{heatmap-calendar}}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{ggplot_calendar_heatmap}\NormalTok{(data.plot,}
...
\includegraphics{edar_files/figure-latex/dataVisHeatmapCalendar-1.pdf}
...
\hypertarget{basis-7}{%
\subsection{Basis}\label{basis-7}}
...
\hypertarget{daily-profiles---overview}{%
\section{Daily Profiles - Overview}\label{daily-profiles---overview}}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{plotDailyProfilesOverview}\NormalTok{(df,}
                               \DataTypeTok{locTimeZone =} \StringTok{"Europe/Zurich"}\NormalTok{,}
                               \DataTypeTok{main =} \StringTok{"Daily Profiles Overview by Weekday and Season"}\NormalTok{,}
                               \DataTypeTok{ylab =} \StringTok{"Energy Consumption (kWh/h)"}\NormalTok{,}
...
\hypertarget{daily-profiles---overlayed}{%
\section{Daily Profiles - Overlayed}\label{daily-profiles---overlayed}}
...
\hypertarget{daily-profiles---decompose}{%
\section{Daily Profiles - Decompose}\label{daily-profiles---decompose}}
...
\hypertarget{daily-profiles---decomposed}{%
\section{Daily Profiles - Decomposed}\label{daily-profiles---decomposed}}
...
\NormalTok{p <-}\StringTok{ }\KeywordTok{plotDailyProfilesDecomposed}\NormalTok{(data, }\DataTypeTok{locTimeZone =} \StringTok{"Europe/Zurich"}\NormalTok{)}
...
\hypertarget{basis-8}{%
\subsection{Basis}\label{basis-8}}
...
\hypertarget{basis-9}{%
\subsection{Basis}\label{basis-9}}
...
\hypertarget{basis-10}{%
\subsection{Basis}\label{basis-10}}
