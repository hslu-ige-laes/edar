...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotDensity} \caption{Density Plot Temperature}\label{fig:unnamed-chunk-25}
\end{figure}
...
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Temperature (\textbackslash{}u00B0C)"}\NormalTok{) }\OperatorTok{+}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotDensitySeasons} \caption{Density Plot Temperature for each season of the year}\label{fig:unnamed-chunk-26}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotSumFrequencyDays} \caption{Sum Frequency Plot Temperature Days}\label{fig:unnamed-chunk-27}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotSumFrequencyHour} \caption{Sum Frequency Plot Temperature}\label{fig:unnamed-chunk-28}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/crossCorrelation} \caption{Building Energy Signature Plot}\label{fig:unnamed-chunk-29}
\end{figure}
...
\NormalTok{dfTempOa}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{cut}\NormalTok{(dfTempOa}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"days"}\NormalTok{)}

\NormalTok{dfTempOa <-}\StringTok{ }\NormalTok{dfTempOa }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempOa =} \KeywordTok{mean}\NormalTok{(centralOutsideTemp)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(day, tempOa) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unique}\NormalTok{()}
...
\NormalTok{dfTempR}\OperatorTok{$}\NormalTok{day <-}\StringTok{ }\KeywordTok{cut}\NormalTok{(dfTempR}\OperatorTok{$}\NormalTok{time, }\DataTypeTok{breaks =} \StringTok{"days"}\NormalTok{)}

\NormalTok{dfTempR <-}\StringTok{ }\NormalTok{dfTempR }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(day) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{tempR =} \KeywordTok{mean}\NormalTok{(FlatA_Temp)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{ungroup}\NormalTok{() }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{select}\NormalTok{(day, tempR) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{unique}\NormalTok{()}
...
\NormalTok{test <-}\StringTok{ }\NormalTok{data }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{filter}\NormalTok{(season }\OperatorTok{==}\StringTok{ "Summer"}\NormalTok{)}

\CommentTok{# plot the cross correlation}
\CommentTok{# ccf(test$tempOa, test$tempR, test$season)}

\CommentTok{# plot(data)}
\KeywordTok{plot}\NormalTok{(}
\NormalTok{  test}\OperatorTok{$}\NormalTok{tempOa,}
\NormalTok{  test}\OperatorTok{$}\NormalTok{tempR)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{# plot diagram}
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggCcf}\NormalTok{(test}\OperatorTok{$}\NormalTok{tempOa,}
\NormalTok{              test}\OperatorTok{$}\NormalTok{tempR,}
...
\includegraphics{edar_files/figure-latex/crossCorrelation2-2.pdf}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/eleHousehold} \caption{Plot Electricity Household}\label{fig:unnamed-chunk-30}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/roomTempRed} \caption{Room Temperature Reduction Plot}\label{fig:unnamed-chunk-31}
\end{figure}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotBldgEngySigScatter} \caption{Building Energy Signature Plot}\label{fig:unnamed-chunk-32}
\end{figure}
