...
\NormalTok{minx <-}\StringTok{ }\KeywordTok{floor}\NormalTok{(}\KeywordTok{min}\NormalTok{(}\OperatorTok{-}\DecValTok{4}\NormalTok{, }\KeywordTok{min}\NormalTok{(data}\OperatorTok{$}\NormalTok{tempOa)))}
\NormalTok{maxx <-}\StringTok{ }\KeywordTok{ceiling}\NormalTok{(}\KeywordTok{max}\NormalTok{(}\DecValTok{32}\NormalTok{, }\KeywordTok{max}\NormalTok{(data}\OperatorTok{$}\NormalTok{tempOa)))}

\NormalTok{miny <-}\StringTok{ }\KeywordTok{floor}\NormalTok{(}\KeywordTok{min}\NormalTok{(}\FloatTok{18.0}\NormalTok{,}\KeywordTok{min}\NormalTok{(data}\OperatorTok{$}\NormalTok{tempR)))}\OperatorTok{-}\DecValTok{1}
...
\StringTok{  }\KeywordTok{add_lines}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.coolSp2,}
            ...
            \DataTypeTok{name =} \StringTok{"Max. heated, cooled or mech. ventilated"}\NormalTok{,}
            ...
            \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Max. heated, cooled or mech. ventilated"}\NormalTok{,}
...
\StringTok{  }\KeywordTok{add_lines}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.coolSp1,}
            \DataTypeTok{x =} \OperatorTok{~}\NormalTok{tempOa,}
            \DataTypeTok{y =} \OperatorTok{~}\NormalTok{tempR,}
            \DataTypeTok{name =} \StringTok{"Max. natural ventilation"}\NormalTok{,}
            \DataTypeTok{opacity =} \FloatTok{0.7}\NormalTok{,}
            \DataTypeTok{color =} \StringTok{"#1E9B8AFF"}\NormalTok{,}
            \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
            \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Max. natural ventilation"}\NormalTok{,}
                           \StringTok{"<br />TempR:   "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, tempR),}
                           \StringTok{"<br />TempOa: "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, tempOa)}
\NormalTok{            )        ) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{add_lines}\NormalTok{(}\DataTypeTok{data =}\NormalTok{ df.heatSp,}
            \DataTypeTok{x =} \OperatorTok{~}\NormalTok{tempOa,}
            \DataTypeTok{y =} \OperatorTok{~}\NormalTok{tempR,}
            \DataTypeTok{name =} \StringTok{"Minimum"}\NormalTok{, }
            \DataTypeTok{opacity =} \FloatTok{0.7}\NormalTok{,}
            \DataTypeTok{color =} \StringTok{"#440154FF"}\NormalTok{,}
            \DataTypeTok{hoverinfo =} \StringTok{"text"}\NormalTok{,}
            \DataTypeTok{text =} \OperatorTok{~}\StringTok{ }\KeywordTok{paste}\NormalTok{(}\StringTok{"Minimum"}\NormalTok{,}
                           \StringTok{"<br />TempR:   "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, tempR),}
                           \StringTok{"<br />TempOa: "}\NormalTok{, }\KeywordTok{sprintf}\NormalTok{(}\StringTok{"%.1f \textbackslash{}u00B0C"}\NormalTok{, tempOa)}
\NormalTok{            )        ) }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{layout}\NormalTok{(}
    \DataTypeTok{xaxis =} \KeywordTok{list}\NormalTok{(}\DataTypeTok{title =} \StringTok{"Outside Air Temperature in \textbackslash{}u00B0C (Rolling Mean last 48 hours)"}\NormalTok{,}
