...
Recipes for such graphical representations are covered in the part ``Data Visualizations'' which brings the calculated numbers to life. The presented code makes the creation of common and useful plots for energy and comfort data fast and easy.
...
This chapter get's you up and running with downloading and installing the relevant software and libraries. This may seem laborious, but it is necessary and easier than it appears at first glance. components.
...
\section{Create an R Script}\label{createFirstScript}}
...
The goal of this book is not to introduce beginners in R to the programming language and the environment in general. There are many really good sources where you can get acquainted with R if necessary.

Two sources are recommended which make it easy to get started with R and teach the relevant basics. Choose one that appeals to you and go through the recommended chapter:
...
Load data from \texttt{*.csv} files
...
\hypertarget{daily-profiles}{%
\chapter{Daily Profiles}\label{daily-profiles}}
...
\hypertarget{decomposed}{%
\section{Decomposed}\label{decomposed}}
