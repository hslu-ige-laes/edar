...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotEnergyConsBeforeAfter} \caption{Energy Consumption Before/After Optimization}\label{fig:energyConsBeforeAfterPng}
\end{figure}
