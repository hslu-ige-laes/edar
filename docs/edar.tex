...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotSeasonalXY} \caption{Energy Consumption Before/After Optimization}\label{fig:unnamed-chunk-4}
\end{figure}
...
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggseasonplot}\NormalTok{(df.ts,}
                     ...
                     \DataTypeTok{main =} \StringTok{"Energy Consumption Overview per Month"}\NormalTok{,}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotSeasonalPolar} \caption{Energy Consumption Before/After Optimization}\label{fig:unnamed-chunk-5}
\end{figure}
...
\NormalTok{plot <-}\StringTok{ }\KeywordTok{ggseasonplot}\NormalTok{(df.ts,}
                     \DataTypeTok{col =} \KeywordTok{viridis}\NormalTok{(numYears),}
                     \DataTypeTok{main =} \StringTok{"Polar Energy Consumption Overview per Month"}\NormalTok{,}
...
\begin{figure}
\includegraphics[width=0.7\linewidth]{images/plotEnergyConsBeforeAfter} \caption{Energy Consumption Before/After Optimization}\label{fig:unnamed-chunk-6}
\end{figure}
