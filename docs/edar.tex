...
\section{Create first R Script}\label{createFirstScript}}
...
With dplyr we can perform a series of operations, for example select and then filter, by sending the results of one function to another using what is called the pipe operator: \texttt{\%\textgreater{}\%}.

Details can be found a href=``\url{https://rafalab.github.io/dsbook/tidyverse.html}'' target="\_blank"\textgreater Introduction to Data Science - Chapter 4.5
