...
\CommentTok{#df <- df %>% filter(timestamp > "2019-11-01 00:00:00", timestamp < "2020-04-01 00:00:00")}
...
\StringTok{  }\KeywordTok{plot_ly}\NormalTok{(}\DataTypeTok{x=}\OperatorTok{~}\NormalTok{x,}
          ...
          \DataTypeTok{hovertemplate =} \KeywordTok{paste}\NormalTok{(}\StringTok{"Time: "}\NormalTok{, }\KeywordTok{format}\NormalTok{(df}\OperatorTok{$}\NormalTok{time, }\StringTok{"%H:%M"}\NormalTok{),}
                                ...
                                \StringTok{"<br>Value: %\{y:.0f\}"}\NormalTok{)) }\OperatorTok{%>%}\StringTok{  }
...
\NormalTok{           ),}
           \DataTypeTok{yaxis =} \KeywordTok{list}\NormalTok{(}
             ...
             \DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(df}\OperatorTok{$}\NormalTok{value)}\OperatorTok{*}\FloatTok{1.05}\NormalTok{)}
\NormalTok{           )}
...
\NormalTok{         ),}
         \DataTypeTok{yaxis =} \KeywordTok{list}\NormalTok{(}
             \DataTypeTok{title =} \StringTok{"Power (kW)"}\NormalTok{,}
             \DataTypeTok{range =} \KeywordTok{c}\NormalTok{(}\DecValTok{0}\NormalTok{, }\KeywordTok{max}\NormalTok{(df}\OperatorTok{$}\NormalTok{dayTimeMean)}\OperatorTok{*}\FloatTok{1.05}\NormalTok{)  }
\NormalTok{         )}
\NormalTok{  ) }\OperatorTok{%>%}\StringTok{ }
\StringTok{  }\KeywordTok{highlight}\NormalTok{(}\DataTypeTok{on =} \StringTok{"plotly_hover"}\NormalTok{,}
            \DataTypeTok{off =} \StringTok{"plotly_doubleclick"}\NormalTok{,}
