...
It is not the goal of this book to introduce beginners in R to the programming language and the environment in general. There are many really good sources where you can familiarize yourself with R if needed.
