...
\section{Download and install}\label{download-and-install}}

Installation instructions according to \citep{Grolemund.2015}
...
\hypertarget{install-from-cran}{%
\subsection{Install from CRAN}\label{install-from-cran}}
