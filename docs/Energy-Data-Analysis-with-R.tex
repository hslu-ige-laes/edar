...
The book is strongly inspired by the {[}R Graphics Cookbook{]} (\url{https://r-graphics.org/}). The goal of this book is to additionaly provide specific recipes for energy and comfort related tasks that can be performed with the R or RStudio program.
...
\hypertarget{how-to-download-and-install-r}{%
\section{How to Download and Install R}\label{how-to-download-and-install-r}}
...
\hypertarget{how-to-download-and-install-rstudio}{%
\section{How to Download and Install RStudio}\label{how-to-download-and-install-rstudio}}
