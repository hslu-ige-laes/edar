## Seasonal Plot - Before/After {#dataVisSeasonalBefAft}
### Goal
...
```{r energyConsBeforeAfter0, warning=FALSE, message=FALSE, collapse = FALSE, echo=FALSE, fig.cap='Raw Data for Seasonal Plot Overlapping Before/After Optimization'}
library(dplyr)
library(lubridate)
