...
If you already have R and R Studio installed, please take a look at the <a href="https://cran.r-project.org/bin/windows/base/" target="_blank">hslu-ige-laes/redutils</a> package on github, which is frequently used throughout this book. Chapter \@ref(installationPackages) shows you how to install it.
...
## Create an R Script {#createFirstScript}
...
As you probably noticed, we did not load any data. The basic installation of "R" and some packages come with test data. So that is an easy way to test something. <a href="https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/00Index.html" target="_blank">The R Dataset Package</a> provides some preinstalled datasets, including the used "Mauna Loa Atmospheric CO2 Concentration" dataset. 
