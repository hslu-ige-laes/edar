...
If you already have "R" and "R Studio" installed, please take a look at the [https://cran.r-project.org/bin/windows/base/](hslu-ige-laes/redutils){target="_blank"} package on github, which is frequently used throughout this book. Chapter \@ref(installationPackages) shows you how to install it.
...
> As you probably noticed, we did not load any data. The basic installation of "R" and some packages come with test data. So that is an easy way to test something. [https://stat.ethz.ch/R-manual/R-devel/library/datasets/html/00Index.html](The R Dataset Package){target="_blank"} provides some preinstalled datasets, including the used "Mauna Loa Atmospheric CO2 Concentration" dataset. 
