...
### Data Basis
```{r comfortSia180ThermCmf0, warning=FALSE, message=FALSE, collapse = FALSE, echo=FALSE, fig.cap='Raw Data Room and Outdoor Temperaturefor SIA180 Thermal Comfort Plot'}
library(dplyr)
library(lubridate)
# read and print data
