...
```{r echo=FALSE, fig.cap='Sum Frequency Plot Temperature Days', out.width='70%'}
knitr::include_graphics("images/plotSumFrequencyDays.png")
```

### Data Basis

```{r sumfrequencydays0, warning=FALSE, message=FALSE, collapse = FALSE, echo=FALSE, fig.cap='Outside Temperature Raw Data for Building Energy Signature Plot', out.width = "70%"}
library(dplyr)
library(lubridate)
...
```{r sumfrequencydays2, warning=FALSE, message=FALSE, collapse = FALSE}
library(ggplot2)
library(plotly)
library(dplyr)
library(lubridate)
...
```{r sumfrequencydays3, warning=FALSE, message=FALSE, collapse = FALSE}
