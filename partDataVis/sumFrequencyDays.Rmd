...
```{r sumfrequencydays0, warning=FALSE, message=FALSE, collapse = FALSE, echo=FALSE, fig.cap='Outside Temperature Raw Data for Sum Frequency Days Plot', out.width = "70%"}
library(dplyr)
library(lubridate)
