## Overlapping
### Goal
Plot a seasonal plot as described in [https://otexts.com/fpp2/seasonal-plots.html](Hyndman and Athanasopoulos (2014, chapter 2.4)){target="_blank"}:
...
```{r seasonalPlotXY0, warning=FALSE, message=FALSE, collapse = FALSE, echo=FALSE, fig.cap='Raw Data for Seasonal Plot Overlapping'}
library(dplyr)
library(lubridate)
