...
```{r mollierhx0, warning=FALSE, message=FALSE, collapse = FALSE, echo=FALSE, fig.cap='Raw Data Temperature and Humidity for Mollier hx Diagram'}
library(dplyr)
library(lubridate)
# read and print data
...
```{r mollierhx2, warning=FALSE, message=FALSE, collapse = FALSE, eval=FALSE}
# save static plot as png (optional)
library(r2d3)
save_d3_png(plot, "images/comfortMollierHx.png")
```
