...
### Goal
Create a plot of detrended mean data per week as recommended in [https://doi.org/10.1016/j.enbuild.2018.07.056]("Building electricity consumption: Data analytics of building operations with classical time series decomposition and case based subsetting", Pickering et al, 2018){target="_blank"}
