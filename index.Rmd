...
It is aimed at R beginners as well as exerienced R users and is strongly inspired by the [https://r-graphics.org/](R Graphics Cookbook){target="_blank"} and [https://smogdr.github.io/edar_coursebook/](Engineering Data Analysis in R){target="_blank"}. The aim of this book is to provide additional specific recipes for energy and comfort related tasks and to make your entry into R smooth and easy. 
...
## Further Reading
A really good source is [http://r4ds.had.co.nz](R for Data Science){target="_blank"} by Garrett Grolemund and Hadley Wickham. The entire book is freely available online through the same format of this book. 

There are a number of recommendable free online books available, including:

- [https://r-graphics.org/](R Graphics Cookbook){target="_blank"}
- [https://rafalab.github.io/dsbook/](Introduction to Data Science - Data Analysis and Prediction Algorithms with R){target="_blank"}
- [https://rstudio-education.github.io/hopr/](Hands-On Programming with R){target="_blank"}
- [https://smogdr.github.io/edar_coursebook/](Engineering Data Analysis in R){target="_blank"}
- [https://otexts.com/fpp2/](Forecasting: Principles and Practice){target="_blank"}
- [https://afit-r.github.io/](AFIT Data Science Lab R Programming Guide){target="_blank"}
...
This book was developed using Yihui Xie's [https://bookdown.org](bookdown){target="_blank"} framework. The book is built  using code that combines R code, data, and text to create a book for which R code and examples can be re-executed every time the book is re-built.

The online book is hosted using GitHub's free [https://pages.github.com](GitHub Pages){target="_blank"}. All material for this book is available and can be explored at the book's [https://github.com/hslu-ige-laes/edar](GitHub repository){target="_blank"}.
