...
It is aimed at R beginners as well as exerienced R users and is strongly inspired by the [R Graphics Cookbook](https://r-graphics.org/){target="_blank"} and [Engineering Data Analysis in R](https://smogdr.github.io/edar_coursebook/){target="_blank"}. The aim of this book is to provide additional specific recipes for energy and comfort related tasks and to make your entry into R smooth and easy. 
...
- [Introduction to Data Science - Data Analysis and Prediction Algorithms with R](https://rafalab.github.io/dsbook/){target="_blank"}
- [Hands-On Programming with R](https://rstudio-education.github.io/hopr/){target="_blank"}
- [Engineering Data Analysis in R](https://smogdr.github.io/edar_coursebook/){target="_blank"}
- [Forecasting: Principles and Practice](https://otexts.com/fpp2/){target="_blank"}
- [AFIT Data Science Lab R Programming Guide](https://afit-r.github.io/){target="_blank"}
