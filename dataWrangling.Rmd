...
```{r metadata season1, warning=FALSE, message=FALSE, collapse = TRUE}
...
```{r metadata season2, warning=FALSE, message=FALSE, collapse = TRUE}
...
```{r metadata season3, warning=FALSE, message=FALSE, collapse = TRUE}
...
### Wide to Long
```{r rbasics wide2long, warning=FALSE, message=FALSE, collapse = TRUE}
...
### Long to Wide
```{r rbasics long2wide, warning=FALSE, message=FALSE, collapse = TRUE}
# long format
head(df.long)
